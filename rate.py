...
def main():
    ...
    set_prefab_specials()
    set_bucket_specials()
    compute_horizontal_aggregate()
    compute_vertical_aggregate()
    find_max()
    compute_true_max()
...
def compute_horizontal_aggregate():
    for special in specials:
...
def compute_vertical_aggregate():
    for special in specials:
